...
const countries = ["United Arab Emirates", "India", "USA", "UK", "Germany", "Other"];
const projectTypes = ["Web App", "Mobile App", "E-commerce", "Maintenance", "Others"];
...
const ProjectForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    setFormData({ name: "", email: "", country: "", types: [], description: "" });
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 px-4 md:px-12 py-16 items-center">
      ...
      <div className="relative w-full max-w-2xl mx-auto">
        ...
        >
          ...
          <div className="mb-6">
            <label className="block text-sm font-medium text-gray-300 mb-2">Type of Project</label>
